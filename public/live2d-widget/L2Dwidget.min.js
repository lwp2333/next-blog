...
var L2Dwidget = (function (t) {
  ...
  function (t, n, e) {
    ...
    ;(p && d) ||
      ...
      'process' == e(9)(l)
        ...
        : v
        ? ((i = (o = new v()).port2), (o.port1.onmessage = w), (r = c(i.postMessage, i, 1)))
                  ...
                  try {
                    u
                      ? (o || (2 == t._h && N(t), (t._h = 1)),
                        ...
                        e === n.promise ? s(P('Promise-chain cycle')) : (i = A(e)) ? i.call(e, a, s) : a(e))
                      : s(r)
                  } catch (t) {
                    f && !c && f.exit(), s(t)
                  }
  ...
  function (t, n, e) {
    'use strict'
    t.exports = {
      model: { jsonPath: 'https://unpkg.com/live2d-widget-model-shizuku@latest/assets/shizuku.model.json', scale: 1 },
